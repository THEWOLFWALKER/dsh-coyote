...
var GuiBridge = class {
	...
	handleConnection(socket) {
		...
		socket.on("close", () => {
			...
			if (this.sockets.size === 0 && this.unsubscribe !== void 0) {
				this.unsubscribe();
...
//#endregion
export { BUILT_IN_WAVEFORMS, Config, CoyoteError, CoyoteRuntime, CoyoteServer, GuiBridge, STRENGTH_MAX, STRENGTH_MIN, apply, composeWave, createCoyoteTools, inject, name, resolveConfig };
